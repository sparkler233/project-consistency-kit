...
- 2026-08-22:同步边界由 wrapup 内部 guard 统一保护;canonical 使用 `synced`,feature 使用与 canonical 的 merge-base 且不得推进项目级 horizon(决策 27)
